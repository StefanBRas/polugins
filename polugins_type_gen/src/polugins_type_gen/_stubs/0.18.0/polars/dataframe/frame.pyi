...
from typing import Any, BinaryIO, Callable, ClassVar, Collection, Iterable, Iterator, Mapping, NoReturn, Sequence
...
class DataFrame:
    ...
    def _read_csv(cls, source: str | Path | BinaryIO | bytes) -> DataFrame:
        ...
        """
    @classmethod
    def _read_parquet(cls, source: str | Path | BinaryIO) -> DataFrame:
        """
        ...
        """
    @classmethod
    def _read_avro(cls, source: str | Path | BinaryIO) -> Self:
        """
        ...
        """
    @classmethod
    def _read_ipc(cls, source: str | Path | BinaryIO) -> Self:
        """
    ...
    def lazy(self) -> LazyFrame:
        ...
        * :meth:`.show_graph() <polars.LazyFrame.show_graph>`
        ...
        '''
    def select(self, exprs: IntoExpr | Iterable[IntoExpr] | None = ..., *more_exprs: IntoExpr, **named_exprs: IntoExpr) -> DataFrame:
        '''
        ...
        **named_exprs
        ...
        '''
    def with_columns(self, exprs: IntoExpr | Iterable[IntoExpr] | None = ..., *more_exprs: IntoExpr, **named_exprs: IntoExpr) -> DataFrame:
        '''
