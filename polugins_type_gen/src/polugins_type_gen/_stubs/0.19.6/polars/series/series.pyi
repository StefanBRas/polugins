...
from polars.utils.deprecation import deprecate_nonkeyword_arguments as deprecate_nonkeyword_arguments, deprecate_renamed_function as deprecate_renamed_function, deprecate_renamed_parameter as deprecate_renamed_parameter, issue_deprecation_warning as issue_deprecation_warning
from polars.utils.meta import get_index_type as get_index_type
from polars.utils.various import _is_generator as _is_generator, parse_percentiles as parse_percentiles, parse_version as parse_version, range_to_series as range_to_series, range_to_slice as range_to_slice, scale_bytes as scale_bytes, sphinx_accessor as sphinx_accessor
...
class Series:
    ...
    def cbrt(self) -> Series:
        ...
        """
    def any(self, *args, **kwargs) -> bool | None:
        """
        ...
        """
    def all(self, *args, **kwargs) -> bool | None:
        """
    ...
    def cut(self, breaks: Sequence[float]) -> Series | DataFrame:
        ...
        '''
    def qcut(self, *args, **kwargs) -> Series | DataFrame:
        '''
    ...
    def kurtosis(self) -> float | None:
        ...
        """
    def clip(self, lower_bound: NumericLiteral | TemporalLiteral | IntoExprColumn, upper_bound: NumericLiteral | TemporalLiteral | IntoExprColumn) -> Series:
        '''
