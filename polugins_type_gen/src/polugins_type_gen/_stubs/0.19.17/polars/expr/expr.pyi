...
from polars.datatypes.classes import Categorical as Categorical, Null as Null, Struct as Struct, UInt32 as UInt32, Utf8 as Utf8
...
class Expr:
    ...
    def cache(self) -> Self:
        ...
        """
    def replace(self, mapping: dict[Any, Any]) -> Self:
        '''
