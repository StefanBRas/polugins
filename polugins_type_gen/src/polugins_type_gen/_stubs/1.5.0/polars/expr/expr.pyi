...
from polars._utils.parse.expr import (
    parse_into_expression as parse_into_expression,
    parse_into_list_of_expressions as parse_into_list_of_expressions,
    parse_predicates_constraints_into_expression as parse_predicates_constraints_into_expression,
)
...
from polars.datatypes.convert import is_polars_dtype as is_polars_dtype
from polars.dependencies import _check_for_numpy as _check_for_numpy
from polars.exceptions import (
    CustomUFuncWarning as CustomUFuncWarning,
    PolarsInefficientMapWarning as PolarsInefficientMapWarning,
)
...
class Expr:
    ...
    @classmethod
    def deserialize(cls, source: str | Path | IOBase | bytes) -> Expr:
        """
    ...
    def slice(self, offset: int | Expr, length: int | Expr | None = ...) -> Expr:
        ...
        └─────┴─────┘
        """
    def append(self, other: IntoExpr) -> Expr:
        """
        Append expressions.
    ...
    def mode(self) -> Expr:
        ...
        └─────┴─────┘
        """
    def cast(self, dtype: PolarsDataType | type[Any]) -> Expr:
        """
    ...
    def top_k(self, k: int | IntoExprColumn = ...) -> Expr:
        ...
        └───────┴──────────┘
        """
    def top_k_by(self, by: IntoExpr | Iterable[IntoExpr], k: int | IntoExprColumn = ...) -> Expr:
        """
    ...
    def bottom_k(self, k: int | IntoExprColumn = ...) -> Expr:
        ...
        └───────┴──────────┘
        """
    def bottom_k_by(self, by: IntoExpr | Iterable[IntoExpr], k: int | IntoExprColumn = ...) -> Expr:
        """
    ...
    def search_sorted(
        ...
        └──────┴───────┴─────┘
        """
    def sort_by(self, by: IntoExpr | Iterable[IntoExpr], *more_by: IntoExpr) -> Expr:
        """
        ...
        *more_by
        ...
        └───────┴────────┴────────┘
        """
    def gather(self, indices: int | Sequence[int] | Expr | Series | np.ndarray[Any, Any]) -> Expr:
        """
    ...
    def get(self, index: int | Expr) -> Expr:
        ...
        └───────┴───────┘
        """
    def shift(self, n: int | IntoExprColumn = ...) -> Expr:
        """
    ...
    def last(self) -> Expr:
        ...
        └─────┘
        """
    def over(self, partition_by: IntoExpr | Iterable[IntoExpr], *more_exprs: IntoExpr) -> Expr:
        """
        ...
        *more_exprs
        ...
        """
    def rolling(self, index_column: str) -> Expr:
        """
    ...
    def quantile(
        ...
        └─────┘
        """
    def cut(self, breaks: Sequence[float]) -> Expr:
        """
        ...
        └─────┴────────────┴────────────┘
        """
    def qcut(self, quantiles: Sequence[float] | int) -> Expr:
        """
    ...
    def interpolate_by(self, by: IntoExpr) -> Expr:
        ...
        └──────┴─────┴────────────────┘
        """
    def rolling_min_by(self, by: IntoExpr, window_size: timedelta | str) -> Expr:
        """
        ...
        └───────┴─────────────────────┴─────────────────┘
        """
    def rolling_max_by(self, by: IntoExpr, window_size: timedelta | str) -> Expr:
        """
        ...
        └───────┴─────────────────────┴─────────────────┘
        """
    def rolling_mean_by(self, by: IntoExpr, window_size: timedelta | str) -> Expr:
        """
        ...
        └───────┴─────────────────────┴──────────────────┘
        """
    def rolling_sum_by(self, by: IntoExpr, window_size: timedelta | str) -> Expr:
        """
        ...
        └───────┴─────────────────────┴─────────────────┘
        """
    def rolling_std_by(self, by: IntoExpr, window_size: timedelta | str) -> Expr:
        """
        ...
        └───────┴─────────────────────┴─────────────────┘
        """
    def rolling_var_by(self, by: IntoExpr, window_size: timedelta | str) -> Expr:
        """
        ...
        └───────┴─────────────────────┴─────────────────┘
        """
    def rolling_median_by(self, by: IntoExpr, window_size: timedelta | str) -> Expr:
        """
        ...
        └───────┴─────────────────────┴────────────────────┘
        """
    def rolling_quantile_by(self, by: IntoExpr, window_size: timedelta | str) -> Expr:
        """
        ...
        └───────┴─────────────────────┴──────────────────────┘
        """
    def rolling_min(self, window_size: int, weights: list[float] | None = ...) -> Expr:
        """
        ...
        └─────┴─────────────┘
        """
    def rolling_max(self, window_size: int, weights: list[float] | None = ...) -> Expr:
        """
        ...
        └─────┴─────────────┘
        """
    def rolling_mean(self, window_size: int, weights: list[float] | None = ...) -> Expr:
        """
        ...
        └─────┴──────────────┘
        """
    def rolling_sum(self, window_size: int | timedelta, weights: list[float] | None = ...) -> Expr:
        """
        ...
        └─────┴─────────────┘
        """
    def rolling_std(self, window_size: int | timedelta, weights: list[float] | None = ...) -> Expr:
        """
        ...
        └─────┴─────────────┘
        """
    def rolling_var(self, window_size: int | timedelta, weights: list[float] | None = ...) -> Expr:
        """
        ...
        """
    def rolling_median(
        self, window_size: int | timedelta, weights: list[float] | None = ...
    ) -> Expr:
        """
    ...
    def rolling_quantile(
        ...
        └─────┴──────────────────┘
        """
    def rolling_skew(self, window_size: int) -> Expr:
        """
    ...
    def abs(self) -> Expr:
        ...
        └─────┘
        """
    def rank(self, method: RankMethod = ...) -> Expr:
        """
    ...
    def shuffle(self, seed: int | None = ...) -> Expr:
        ...
        └─────┘
        """
    def sample(self, n: int | IntoExprColumn | None = ...) -> Expr:
        """
    ...
    def ewm_mean(self) -> Expr:
        ...
        └──────────┘
        """
    def ewm_mean_by(self, by: str | IntoExpr) -> Expr:
        """
    ...
    def log1p(self) -> Expr:
        ...
        └──────────┘
        """
    def entropy(self, base: float = ...) -> Expr:
        """
        ...
        └───────────┘
        """
    def cumulative_eval(self, expr: Expr) -> Expr:
        """
    ...
    def shrink_dtype(self) -> Expr:
        ...
        └─────┴────────────┴────────────┴──────┴──────┴─────┴──────┴───────┘
        """
    def hist(self, bins: IntoExpr | None = ...) -> Expr:
        """
