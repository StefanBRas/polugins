...
from polars.datatypes.classes import Categorical as Categorical, Struct as Struct, UInt32 as UInt32, Utf8 as Utf8
...
class Expr:
    ...
    def slice(self, offset: int | Expr, length: int | Expr | None = ...) -> Self:
        ...
        '''
    def append(self, other: Expr) -> Self:
        '''
        Append expressions.
    ...
    def shift(self, periods: int = ...) -> Self:
        ...
        '''
    def shift_and_fill(self, fill_value: int | float | bool | str | Expr | list[Any]) -> Self:
        '''
