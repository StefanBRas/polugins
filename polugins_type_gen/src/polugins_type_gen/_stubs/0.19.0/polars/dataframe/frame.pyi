...
from polars.datatypes.classes import Boolean as Boolean, DataTypeClass as DataTypeClass, FLOAT_DTYPES as FLOAT_DTYPES, Float64 as Float64, NUMERIC_DTYPES as NUMERIC_DTYPES, Object as Object, Utf8 as Utf8
from polars.datatypes.convert import py_type_to_dtype as py_type_to_dtype
from polars.dependencies import _check_for_numpy as _check_for_numpy, _check_for_pandas as _check_for_pandas, _check_for_pyarrow as _check_for_pyarrow, dataframe_api_compat as dataframe_api_compat
...
from polars.functions.lazy import col as col
...
from typing import Any, BinaryIO, Callable, ClassVar as _ClassVar, Collection, Iterable, Iterator, Mapping, NoReturn, Sequence
...
class DataFrame:
    ...
    def _from_pandas(cls, data: pd.DataFrame, schema: SchemaDefinition | None = ...) -> Self:
        ...
        """
    @classmethod
    def _read_csv(cls, source: str | Path | BinaryIO | bytes) -> DataFrame:
        """
        ...
        """
    @classmethod
    def _read_parquet(cls, source: str | Path | BinaryIO | bytes) -> DataFrame:
        """
    ...
    def _read_avro(cls, source: str | Path | BinaryIO | bytes) -> Self:
        ...
        """
    @classmethod
    def _read_ipc(cls, source: str | Path | BinaryIO | bytes) -> Self:
        '''
        ...
        '''
    @classmethod
    def _read_ipc_stream(cls, source: str | Path | BinaryIO | bytes) -> Self:
        '''
    ...
    def write_database(self, *args, **kwargs) -> None:
        ...
        '''
    def write_delta(self, target: str | Path | deltalake.DeltaTable) -> None:
        '''
    ...
    def insert_at_idx(self, index: int, series: Series) -> Self:
        ...
        '''
    def filter(self, predicate: Expr | str | Series | list[bool] | np.ndarray[Any, Any] | bool) -> DataFrame:
        '''
    ...
    def hstack(self, columns: list[Series] | DataFrame) -> Self:
        ...
        '''
    def vstack(self, *args, **kwargs) -> Self:
        '''
    ...
    def approx_n_unique(self) -> DataFrame:
        ...
        '''
    def approx_unique(self, *args, **kwargs) -> DataFrame:
        """
        Approximate count of unique values.
    ...
    def null_count(self) -> Self:
        ...
        '''
    def sample(self, n: int | None = ...) -> Self:
        '''
    ...
    def set_sorted(self, column: str | Iterable[str], *more_columns: str) -> DataFrame:
        ...
        """
    def update(self, other: DataFrame, on: str | Sequence[str] | None = ..., how: Literal['left', 'inner'] = ...) -> DataFrame:
        '''
        ...
        '''
    def groupby(self, *args, **kwargs) -> GroupBy:
        """
        Start a group by operation.
        ...
        *more_by
        ...
        """
    def groupby_rolling(self, *args, **kwargs) -> RollingGroupBy:
        """
        Create rolling groups based on a time, Int32, or Int64 column.
        ...
        """
    def groupby_dynamic(self, *args, **kwargs) -> DynamicGroupBy:
        '''
        Group based on a time value (or index value of type Int32, Int64).
        ...
        '''
    def apply(self, *args, **kwargs) -> DataFrame:
        """
        Apply a custom/user-defined function (UDF) over the rows of the DataFrame.
