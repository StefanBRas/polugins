...
class Series:
    ...
    def set(self, filter: Series, value: int | float | str | bool | None) -> Series:
        ...
        '''
    def scatter(self, indices: Series | np.ndarray[Any, Any] | Sequence[int] | int, values: int | float | str | bool | date | datetime | Sequence[int] | Sequence[float] | Sequence[bool] | Sequence[str] | Sequence[date] | Sequence[datetime] | Series | None) -> Series:
        '''
