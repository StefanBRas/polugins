...
from polars._utils.deprecation import (
    ...
    validate_rolling_aggs_arguments as validate_rolling_aggs_arguments,
    validate_rolling_by_aggs_arguments as validate_rolling_by_aggs_arguments,
)
from polars._utils.parse_expr_input import (
    ...
    parse_predicates_constraints_as_expression as parse_predicates_constraints_as_expression,
)
...
from polars.datatypes.classes import Int64 as Int64, List as List
...
class Expr:
    ...
    def top_k(self, k: int | IntoExprColumn = ...) -> Self:
        ...
        └───────┴──────────┘
        """
    def top_k_by(self, by: IntoExpr | Iterable[IntoExpr], k: int | IntoExprColumn = ...) -> Self:
        """
    ...
    def bottom_k(self, k: int | IntoExprColumn = ...) -> Self:
        ...
        └───────┴──────────┘
        """
    def bottom_k_by(self, by: IntoExpr | Iterable[IntoExpr], k: int | IntoExprColumn = ...) -> Self:
        """
    ...
    def sort_by(self, by: IntoExpr | Iterable[IntoExpr], *more_by: IntoExpr) -> Self:
        ...
        *more_by
        ...
        └───────┴────────┴────────┘
        """
    def gather(self, indices: int | Sequence[int] | Expr | Series | np.ndarray[Any, Any]) -> Self:
        """
    ...
    def interpolate_by(self, by: IntoExpr) -> Self:
        ...
        └──────┴─────┴────────────────┘
        """
    def rolling_min_by(self, by: IntoExpr, window_size: timedelta | str) -> Self:
        """
        ...
        └───────┴─────────────────────┴─────────────────┘
        """
    def rolling_max_by(self, by: IntoExpr, window_size: timedelta | str) -> Self:
        """
        ...
        └───────┴─────────────────────┴─────────────────┘
        """
    def rolling_mean_by(self, by: IntoExpr, window_size: timedelta | str) -> Self:
        """
        ...
        └───────┴─────────────────────┴──────────────────┘
        """
    def rolling_sum_by(self, by: IntoExpr, window_size: timedelta | str) -> Self:
        """
        ...
        └───────┴─────────────────────┴─────────────────┘
        """
    def rolling_std_by(self, by: IntoExpr, window_size: timedelta | str) -> Self:
        """
        ...
        └───────┴─────────────────────┴─────────────────┘
        """
    def rolling_var_by(self, by: IntoExpr, window_size: timedelta | str) -> Self:
        """
        ...
        └───────┴─────────────────────┴─────────────────┘
        """
    def rolling_median_by(self, by: IntoExpr, window_size: timedelta | str) -> Self:
        """
        ...
        └───────┴─────────────────────┴────────────────────┘
        """
    def rolling_quantile_by(self, by: IntoExpr, window_size: timedelta | str) -> Self:
        """
    ...
    def radians(self) -> Self:
        ...
        """
    def reshape(
        self, dimensions: tuple[int, ...], nested_type: type[Array] | type[List] = ...
    ) -> Self:
        """
    ...
    def ewm_mean(self) -> Self:
        ...
        └──────────┘
        """
    def ewm_mean_by(self, by: str | IntoExpr) -> Self:
        """
