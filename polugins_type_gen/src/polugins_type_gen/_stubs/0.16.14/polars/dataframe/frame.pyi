...
from polars.exceptions import (
    NoRowsReturned as NoRowsReturned,
    TooManyRowsReturned as TooManyRowsReturned,
)
...
class DataFrame:
    ...
    def _read_csv(
        ...
        quote_char: str | None = ...,
        skip_rows: int = ...,
        dtypes: None | SchemaDict | Sequence[PolarsDataType] = ...,
    ...
    def write_excel(
        ...
        """
    def write_ipc(
        self, file: BinaryIO | BytesIO | str | Path, compression: IpcCompression = ...
    ) -> None:
        """
    ...
    def insert_at_idx(self, index: int, series: Series) -> Self:
        ...
        """
    def filter(
        self, predicate: pli.Expr | str | Series | list[bool] | np.ndarray[Any, Any] | bool
    ) -> Self:
        """
    ...
    def drop_nulls(self, subset: str | Sequence[str] | None = ...) -> Self:
        ...
        """
    def pipe(
        self, func: Callable[Concatenate[DataFrame, P], T], *args: P.args, **kwargs: P.kwargs
    ) -> T:
        """
    ...
    def pivot(
        ...
        aggregate_function: PivotAgg | pli.Expr = ...,
    ) -> Self:
        """
    ...
    def merge_sorted(self, other: DataFrame, key: str) -> Self:
        ...
        """
    def update(
        self, other: DataFrame, on: None | str | Sequence[str] = ..., how: str = ...
    ) -> Self:
        """
