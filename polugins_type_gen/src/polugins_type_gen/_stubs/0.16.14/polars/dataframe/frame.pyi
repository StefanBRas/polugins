...
from polars.datatypes.classes import Boolean as Boolean, Categorical as Categorical, DataTypeClass as DataTypeClass, Float64 as Float64, Int16 as Int16, Int32 as Int32, Int64 as Int64, Int8 as Int8, Object as Object, UInt16 as UInt16, UInt32 as UInt32, UInt64 as UInt64, UInt8 as UInt8, Utf8 as Utf8
...
from polars.exceptions import NoRowsReturned as NoRowsReturned, TooManyRowsReturned as TooManyRowsReturned
from polars.internals.construction import _post_apply_columns as _post_apply_columns, arrow_to_pydf as arrow_to_pydf, dict_to_pydf as dict_to_pydf, iterable_to_pydf as iterable_to_pydf, numpy_to_pydf as numpy_to_pydf, pandas_to_pydf as pandas_to_pydf, sequence_to_pydf as sequence_to_pydf, series_to_pydf as series_to_pydf
...
class DataFrame:
    ...
    @classmethod
    def _from_dicts(cls, data: Sequence[dict[str, Any]], infer_schema_length: int | None = ..., schema: SchemaDefinition | None = ..., schema_overrides: SchemaDict | None = ...) -> Self: ...
    @classmethod
    def _from_dict(cls, data: Mapping[str, Sequence[object] | Mapping[str, Sequence[object]] | Series], schema: SchemaDefinition | None = ..., schema_overrides: SchemaDict | None = ...) -> Self:
        ...
        """
    @classmethod
    def _from_records(cls, *args, **kwargs) -> Self:
        """
        ...
        """
    @classmethod
    def _from_numpy(cls, *args, **kwargs) -> Self:
        """
        ...
        """
    @classmethod
    def _from_arrow(cls, *args, **kwargs) -> Self:
        """
        ...
        """
    @classmethod
    def _from_pandas(cls, *args, **kwargs) -> Self:
        """
    ...
    def __getitem__(self, item: str | int | np.ndarray[Any, Any] | MultiColSelector | tuple[int, MultiColSelector] | tuple[MultiRowSelector, MultiColSelector] | tuple[MultiRowSelector, int] | tuple[MultiRowSelector, str] | tuple[int, int] | tuple[int, str]) -> DataFrame | Series:
    ...
    def insert_at_idx(self, index: int, series: Series) -> Self:
        ...
        '''
    def filter(self, predicate: pli.Expr | str | Series | list[bool] | np.ndarray[Any, Any] | bool) -> Self:
        '''
    ...
    def drop_nulls(self, subset: str | Sequence[str] | None = ...) -> Self:
        ...
        '''
    def pipe(self, func: Callable[Concatenate[DataFrame, P], T], *args: P.args, **kwargs: P.kwargs) -> T:
        '''
    ...
    def groupby(self, by: IntoExpr | Iterable[IntoExpr], *more_by: IntoExpr) -> GroupBy[Self]:
        ...
        *more_by
        ...
        '''
    def groupby_rolling(self, index_column: str) -> RollingGroupBy[Self]:
        '''
        ...
        *groupby_dynamic*
        ...
        '''
    def groupby_dynamic(self, index_column: str) -> DynamicGroupBy[Self]:
        '''
    ...
    def join_asof(self, other: DataFrame) -> Self:
        ...
        '''
    def join(self, other: DataFrame) -> Self:
        '''
    ...
    def fill_nan(self, fill_value: pli.Expr | int | float | None) -> Self:
        ...
        '''
    def explode(self, columns: str | Sequence[str] | pli.Expr | Sequence[pli.Expr], *more_columns: str | pli.Expr) -> Self:
        '''
        ...
        *more_columns
        ...
        '''
    def pivot(self, values: Sequence[str] | str, index: Sequence[str] | str, columns: Sequence[str] | str, aggregate_function: PivotAgg | pli.Expr = ...) -> Self:
        '''
    ...
    def unstack(self, step: int, how: UnstackDirection = ..., columns: str | Sequence[str] | None = ..., fill_values: list[Any] | None = ...) -> Self:
        ...
        '''
    def partition_by(self, *args, **kwargs) -> list[Self] | dict[Any, Self]:
        '''
    ...
    def select(self, exprs: IntoExpr | Iterable[IntoExpr] | None = ..., *more_exprs: IntoExpr, **named_exprs: IntoExpr) -> Self:
        ...
        **named_exprs
        ...
        '''
    def with_columns(self, exprs: IntoExpr | Iterable[IntoExpr] = ..., *more_exprs: IntoExpr, **named_exprs: IntoExpr) -> Self:
        '''
    ...
    def unique(self) -> Self:
        ...
        '''
    def n_unique(self, subset: str | pli.Expr | Sequence[str | pli.Expr] | None = ...) -> int:
        '''
    ...
    def to_struct(self, name: str) -> Series:
        ...
        '''
    def unnest(self, *args, **kwargs) -> Self:
        '''
    ...
    def merge_sorted(self, other: DataFrame, key: str) -> Self:
        ...
        """
    def update(self, other: DataFrame, on: None | str | Sequence[str] = ..., how: str = ...) -> Self:
        '''
