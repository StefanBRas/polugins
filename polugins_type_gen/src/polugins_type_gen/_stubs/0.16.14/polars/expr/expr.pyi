...
def selection_to_pyexpr_list(exprs: IntoExpr | Iterable[IntoExpr], structify: bool = ...) -> list[PyExpr]: ...
def expr_output_name(expr: Expr) -> str | None: ...
def expr_to_lit_or_expr(expr: IntoExpr | Iterable[IntoExpr], str_to_lit: bool = ..., structify: bool = ..., name: str | None = ...) -> Expr:
    '''
