...
from polars.internals.construction import arrow_to_pyseries as arrow_to_pyseries, iterable_to_pyseries as iterable_to_pyseries, numpy_to_pyseries as numpy_to_pyseries, pandas_to_pyseries as pandas_to_pyseries, sequence_to_pyseries as sequence_to_pyseries, series_to_pyseries as series_to_pyseries
...
from typing import Any, ArrayLike, Callable, ClassVar, NoReturn, Sequence
...
class Series:
    ...
    def to_dummies(self, separator: str = ...) -> DataFrame:
        ...
        '''
    def cut(self, bins: list[float], labels: list[str] | None = ..., break_point_label: str = ..., category_label: str = ...) -> DataFrame:
        '''
