...
class Expr:
    ...
    def quantile(self, quantile: float | Expr, interpolation: RollingInterpolationMethod = ...) -> Self:
        ...
        '''
    def cut(self, breaks: list[float], labels: list[str] | None = ..., left_closed: bool = ...) -> Self:
        '''
        ...
        └─────┴─────┴───────────┘
        '''
    def qcut(self, probs: list[float], labels: list[str] | None = ..., left_closed: bool = ..., allow_duplicates: bool = ...) -> Self:
        '''
