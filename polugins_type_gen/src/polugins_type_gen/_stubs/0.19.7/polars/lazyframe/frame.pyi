...
class LazyFrame:
    ...
    def profile(self) -> tuple[DataFrame, DataFrame]:
        ...
        '''
    def collect(self, **kwargs: Any) -> DataFrame:
        '''
    ...
    def set_sorted(self, column: str | Iterable[str], *more_columns: str) -> Self:
        ...
        """
    def update(self, other: LazyFrame, on: str | Sequence[str] | None = ..., left_on: str | Sequence[str] | None = ..., right_on: str | Sequence[str] | None = ..., how: Literal['left', 'inner'] = ...) -> Self:
        '''
