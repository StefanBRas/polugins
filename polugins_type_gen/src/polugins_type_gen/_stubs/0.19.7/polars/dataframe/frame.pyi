...
class DataFrame:
    ...
    def write_parquet(self, file: str | Path | BytesIO) -> None:
        ...
        '''
    def write_database(self, table_name: str, connection: str) -> None:
        '''
    ...
    def set_sorted(self, column: str | Iterable[str], *more_columns: str) -> DataFrame:
        ...
        """
    def update(self, other: DataFrame, on: str | Sequence[str] | None = ..., left_on: str | Sequence[str] | None = ..., right_on: str | Sequence[str] | None = ..., how: Literal['left', 'inner'] = ...) -> DataFrame:
        '''
