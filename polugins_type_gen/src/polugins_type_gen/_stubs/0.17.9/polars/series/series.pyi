...
from polars.utils.various import _is_generator as _is_generator, is_int_sequence as is_int_sequence, parse_version as parse_version, range_to_series as range_to_series, range_to_slice as range_to_slice, scale_bytes as scale_bytes, sphinx_accessor as sphinx_accessor
...
class Series:
    ...
    @classmethod
    def _from_pandas(cls, name: str, values: pd.Series | pd.DatetimeIndex) -> Self:
    ...
    def cut(self, bins: list[float], labels: list[str] | None = ..., break_point_label: str = ..., category_label: str = ...) -> DataFrame:
        ...
        '''
    def qcut(self, quantiles: list[float]) -> DataFrame:
        '''
    ...
    def shift(self, periods: int = ...) -> Series:
        ...
        '''
    def shift_and_fill(self, fill_value: int | pli.Expr) -> Series:
        """
