...
class Expr:
    ...
    def rolling_min_by(self, by: IntoExpr, window_size: timedelta | str) -> Self:
        ...
        └───────┴─────────────────────┴─────────────────┘
        """
    def rolling_max_by(self, by: str, window_size: timedelta | str) -> Self:
        """
        ...
        └───────┴─────────────────────┴─────────────────┘
        """
    def rolling_mean_by(self, by: str, window_size: timedelta | str) -> Self:
        """
        ...
        └───────┴─────────────────────┴──────────────────┘
        """
    def rolling_sum_by(self, by: str, window_size: timedelta | str) -> Self:
        """
        ...
        └───────┴─────────────────────┴─────────────────┘
        """
    def rolling_std_by(self, by: str, window_size: timedelta | str) -> Self:
        """
        ...
        └───────┴─────────────────────┴─────────────────┘
        """
    def rolling_var_by(self, by: str, window_size: timedelta | str) -> Self:
        """
        ...
        └───────┴─────────────────────┴─────────────────┘
        """
    def rolling_median_by(self, by: str, window_size: timedelta | str) -> Self:
        """
        ...
        └───────┴─────────────────────┴────────────────────┘
        """
    def rolling_quantile_by(self, by: str, window_size: timedelta | str) -> Self:
        """
