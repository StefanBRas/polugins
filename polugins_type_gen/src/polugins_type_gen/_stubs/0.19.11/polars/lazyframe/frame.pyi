...
from polars.utils.deprecation import deprecate_function as deprecate_function, deprecate_renamed_function as deprecate_renamed_function, deprecate_renamed_parameter as deprecate_renamed_parameter, issue_deprecation_warning as issue_deprecation_warning
from polars.utils.various import _in_notebook as _in_notebook, _prepare_row_count_args as _prepare_row_count_args, _process_null_values as _process_null_values, find_stacklevel as find_stacklevel, is_bool_sequence as is_bool_sequence, is_sequence as is_sequence, normalize_filepath as normalize_filepath
...
class LazyFrame:
    ...
    def _scan_ndjson(cls, source: str | Path | list[str] | list[Path]) -> Self:
        ...
        """
    @classmethod
    def _scan_python_function(cls, schema: pa.schema | dict[str, PolarsDataType], scan_fn: Any) -> Self: ...
    @classmethod
    ...
    def set_sorted(self, column: str | Iterable[str], *more_columns: str) -> Self:
        ...
        """
    def update(self, other: LazyFrame, on: str | Sequence[str] | None = ..., left_on: str | Sequence[str] | None = ..., right_on: str | Sequence[str] | None = ..., how: Literal['left', 'inner', 'outer'] = ..., include_nulls: bool | None = ...) -> Self:
        '''
