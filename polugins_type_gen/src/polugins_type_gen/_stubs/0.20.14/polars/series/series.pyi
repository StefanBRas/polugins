...
from polars._utils.construction import arrow_to_pyseries as arrow_to_pyseries, dataframe_to_pyseries as dataframe_to_pyseries, iterable_to_pyseries as iterable_to_pyseries, numpy_to_idxs as numpy_to_idxs, numpy_to_pyseries as numpy_to_pyseries, pandas_to_pyseries as pandas_to_pyseries, sequence_to_pyseries as sequence_to_pyseries, series_to_pyseries as series_to_pyseries
from polars._utils.convert import date_to_int as date_to_int, datetime_to_int as datetime_to_int, time_to_int as time_to_int, timedelta_to_int as timedelta_to_int
...
from polars._utils.various import _is_generator as _is_generator, no_default as no_default, parse_version as parse_version, range_to_slice as range_to_slice, scale_bytes as scale_bytes, sphinx_accessor as sphinx_accessor, warn_null_comparison as warn_null_comparison
...
from polars.dependencies import _check_for_numpy as _check_for_numpy, _check_for_pandas as _check_for_pandas, _check_for_pyarrow as _check_for_pyarrow, hvplot as hvplot
...
class Series:
    ...
    def _from_buffer(self, dtype: PolarsDataType, buffer_info: BufferInfo, owner: Any) -> Self:
        ...
        This method is mainly intended for use with the dataframe interchange protocol.
        """
    def _from_buffers(self, dtype: PolarsDataType, data: Series | Sequence[Series], validity: Series | None = ...) -> Self:
        """
    ...
    def tanh(self) -> Series:
        ...
        '''
    def map_elements(self, function: Callable[[Any], Any], return_dtype: PolarsDataType | None = ...) -> Self:
        '''
    ...
    def rolling_var(self, window_size: int, weights: list[float] | None = ..., min_periods: int | None = ...) -> Series:
        ...
        '''
    def rolling_map(self, function: Callable[[Series], Any], window_size: int, weights: list[float] | None = ..., min_periods: int | None = ...) -> Series:
        '''
    ...
    def is_utf8(self) -> bool:
        ...
        True
        '''
    def take_every(self, n: int, offset: int = ...) -> Series:
        """
        Take every nth value in the Series and return as new Series.
    ...
    def take(self, indices: int | list[int] | Expr | Series | np.ndarray[Any, Any]) -> Series:
        ...
        indices
            Index location used for selection.
        """
    def set_at_idx(self, indices: Series | np.ndarray[Any, Any] | Sequence[int] | int, values: int | float | str | bool | date | datetime | Sequence[int] | Sequence[float] | Sequence[bool] | Sequence[str] | Sequence[date] | Sequence[datetime] | Series | None) -> Series:
        """
        Set values at the index locations.
