...
from polars.series.plotting import SeriesPlot as SeriesPlot
...
from typing import Any, ArrayLike, Callable, ClassVar as _ClassVar, NoReturn
...
class Series:
    ...
    def equals(self, other: Series) -> bool:
        ...
        False
        """
    def cast(self, dtype: type[int | float | str | bool] | PolarsDataType) -> Self:
        """
