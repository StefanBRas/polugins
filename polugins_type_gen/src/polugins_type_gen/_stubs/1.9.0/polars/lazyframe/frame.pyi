...
from polars._utils.async_ import (
...
from polars._utils.serde import serialize_polars_object as serialize_polars_object
from polars._utils.slice import LazyPolarsSlice as LazyPolarsSlice
...
from polars._utils.various import (
    ...
    issue_warning as issue_warning,
    normalize_filepath as normalize_filepath,
    parse_percentiles as parse_percentiles,
)
from polars._utils.wrap import wrap_df as wrap_df, wrap_expr as wrap_expr
...
from polars.datatypes.group import DataTypeGroup as DataTypeGroup
from polars.dependencies import import_optional as import_optional
from polars.exceptions import PerformanceWarning as PerformanceWarning
from polars.lazyframe.engine_config import GPUEngine as GPUEngine
...
from polars.selectors import by_dtype as by_dtype, expand_selector as expand_selector
...
class LazyFrame:
    ...
    def serialize(self, file: IOBase | str | Path | None = ...) -> bytes | str | None:
        """
    ...
    def inspect(self, fmt: str = ...) -> LazyFrame:
        ...
        <LazyFrame at ...>
        """
    def sort(self, by: IntoExpr | Iterable[IntoExpr], *more_by: IntoExpr) -> LazyFrame:
        """
        ...
        *more_by
        ...
        └──────┴─────┴─────┘
        """
    def sql(self, query: str) -> LazyFrame:
        """
        ...
        * More control over registration and execution behaviour is available by
        ...
        └─────┴───────────┴─────┴───────┘
        """
    def top_k(self, k: int) -> LazyFrame:
        """
        ...
        └─────┴─────┘
        """
    def bottom_k(self, k: int) -> LazyFrame:
        """
    ...
    def profile(self) -> tuple[DataFrame, DataFrame]:
        ...
        (shape: (3, 3)
         ...
         └─────────────────────────┴───────┴──────┘)
        """
    def collect(self, **_kwargs: Any) -> DataFrame | InProcessQuery:
        """
    ...
    def sink_parquet(self, path: str | Path) -> None:
        ...
        """
    def sink_ipc(self, path: str | Path) -> None:
        """
    ...
    def fetch(self, n_rows: int = ...) -> DataFrame:
        ...
        """
    def _fetch(self, n_rows: int = ...) -> DataFrame:
        """
        Collect a small number of rows for debugging purposes.
    ...
    def group_by_dynamic(self, index_column: IntoExpr) -> LazyGroupBy:
        ...
        └─────────────────┴─────────────────┴─────┴─────────────────┘
        """
    def join_asof(self, other: LazyFrame) -> LazyFrame:
        """
    ...
    def join(
        ...
        └─────┴─────┴─────┘
        """
    def join_where(self, other: LazyFrame, *predicates: Expr | Iterable[Expr]) -> LazyFrame:
        """
    ...
    def with_context(self, other: Self | list[Self]) -> LazyFrame:
        ...
        └───────────┘
        """
    def drop(self, *columns: ColumnNameOrSelector | Iterable[ColumnNameOrSelector]) -> LazyFrame:
        """
    ...
    def reverse(self) -> LazyFrame:
        ...
        └─────┴─────┘
        """
    def shift(self, n: int | IntoExprColumn = ...) -> LazyFrame:
        """
    ...
    def drop_nulls(
        ...
        """
    def unpivot(
        self, on: ColumnNameOrSelector | Sequence[ColumnNameOrSelector] | None = ...
    ) -> LazyFrame:
        """
        ...
        └─────┴──────────┴───────┘
        """
    def map_batches(self, function: Callable[[DataFrame], DataFrame]) -> LazyFrame:
        """
    ...
    def merge_sorted(self, other: LazyFrame, key: str) -> LazyFrame:
        ...
        └────────┴─────┘
        """
    def set_sorted(self, column: str) -> LazyFrame:
        """
