...
from polars._utils.parse.expr import parse_into_expression as parse_into_expression
...
from polars.dataframe.plotting import DataFramePlot as DataFramePlot
...
_ALTAIR_AVAILABLE: bool
_GREAT_TABLES_AVAILABLE: bool
...
class DataFrame:
    ...
    def _from_arrow(
        ...
        """
    @classmethod
    def _from_pandas(cls, data: pd.DataFrame, schema: SchemaDefinition | None = ...) -> DataFrame:
        """
    ...
    def write_excel(
        ...
        * Formula dictionaries *must* contain a key called "formula", and then optional
        ...
        """
    def write_ipc(self, file: str | Path | IO[bytes] | None) -> BytesIO | None:
        """
        ...
        >>> df.write_ipc(path)
        """
    def write_ipc_stream(self, file: str | Path | IO[bytes] | None) -> BytesIO | None:
        """
    ...
    def pipe(
        ...
        **kwargs
        ...
        └─────┴─────┘
        """
    def with_row_index(self, name: str = ..., offset: int = ...) -> DataFrame:
        """
    ...
    def group_by_dynamic(self, index_column: IntoExpr) -> DynamicGroupBy:
        ...
        └─────────────────┴─────────────────┴─────┴─────────────────┘
        """
    def upsample(self, time_column: str) -> DataFrame:
        """
    ...
    def join(
        ...
        """
    def join_where(self, other: DataFrame, *predicates: Expr | Iterable[Expr]) -> DataFrame:
        """
    ...
    def map_rows(
        ...
        * If your function is expensive and you don\'t want it to be called more than
        ...
        """
    def hstack(self, columns: list[Series] | DataFrame) -> DataFrame:
        """
    ...
    def cast(
        ...
        """
    def clear(self, n: int = ...) -> DataFrame:
        """
    ...
    def explode(
        ...
        *more_columns
        ...
        └─────────┴─────────┘
        """
    def pivot(self, on: ColumnNameOrSelector | Sequence[ColumnNameOrSelector]) -> DataFrame:
        """
    ...
    def null_count(self) -> DataFrame:
        ...
        └─────┴─────┴─────┘
        """
    def sample(self, n: int | Series | None = ...) -> DataFrame:
        """
    ...
    def merge_sorted(self, other: DataFrame, key: str) -> DataFrame:
        ...
        └────────┴─────┘
        """
    def set_sorted(self, column: str) -> DataFrame:
        """
