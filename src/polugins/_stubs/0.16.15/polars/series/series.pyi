...
from polars.datatypes import Boolean as Boolean, Categorical as Categorical, Date as Date, Datetime as Datetime, Duration as Duration, Float32 as Float32, Float64 as Float64, Int16 as Int16, Int32 as Int32, Int64 as Int64, Int8 as Int8, List as List, Time as Time, UInt16 as UInt16, UInt32 as UInt32, UInt64 as UInt64, UInt8 as UInt8, Utf8 as Utf8, dtype_to_ctype as dtype_to_ctype, is_polars_dtype as is_polars_dtype, maybe_cast as maybe_cast, numpy_char_code_to_dtype as numpy_char_code_to_dtype, py_type_to_dtype as py_type_to_dtype, supported_numpy_char_code as supported_numpy_char_code
...
from typing import Any, Callable, Collection, NoReturn, Sequence, overload
...
class Series:
    ...
    @classmethod
    def _from_pandas(cls, name: str, values: pd.Series | pd.DatetimeIndex, nan_to_null: bool = ...) -> Self: ...
    @classmethod
    ...
    @overload
    def __getitem__(self, item: Series | range | slice | np.ndarray[Any, Any] | list[int] | list[bool]) -> Series: ...
    ...
    def top_k(self, k: int = ..., descending: bool = ...) -> Series: ...
    def arg_sort(self, descending: bool = ..., nulls_last: bool = ...) -> Series: ...
    def argsort(self, descending: bool = ..., nulls_last: bool = ...) -> Series: ...
    ...
    def to_pandas(self, *args: Any, use_pyarrow_extension_array: bool = ..., **kwargs: Any) -> pd.Series: ...
    ...
    def abs(self) -> Series: ...
    def rank(self, method: RankMethod = ..., descending: bool = ...) -> Series: ...
    ...
    def map_dict(self, remapping: dict[Any, Any], *, default: Any = ...) -> Self: ...
