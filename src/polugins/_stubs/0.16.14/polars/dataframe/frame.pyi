...
class DataFrame:
    ...
    def groupby_rolling(self, index_column: str, *, period: str | timedelta, offset: str | timedelta | None = ..., closed: ClosedInterval = ..., by: IntoExpr | Iterable[IntoExpr] | None = ...) -> RollingGroupBy[Self]: ...
    def groupby_dynamic(self, index_column: str, *, every: str | timedelta, period: str | timedelta | None = ..., offset: str | timedelta | None = ..., truncate: bool = ..., include_boundaries: bool = ..., closed: ClosedInterval = ..., by: IntoExpr | Iterable[IntoExpr] | None = ..., start_by: StartBy = ...) -> DynamicGroupBy[Self]: ...
    ...
    def join_asof(self, other: DataFrame, left_on: str | None | pli.Expr = ..., right_on: str | None | pli.Expr = ..., on: str | None | pli.Expr = ..., by_left: str | Sequence[str] | None = ..., by_right: str | Sequence[str] | None = ..., by: str | Sequence[str] | None = ..., strategy: AsofJoinStrategy = ..., suffix: str = ..., tolerance: str | int | float | None = ..., allow_parallel: bool = ..., force_parallel: bool = ...) -> Self: ...
    def join(self, other: DataFrame, left_on: str | pli.Expr | Sequence[str | pli.Expr] | None = ..., right_on: str | pli.Expr | Sequence[str | pli.Expr] | None = ..., on: str | pli.Expr | Sequence[str | pli.Expr] | None = ..., how: JoinStrategy = ..., suffix: str = ...) -> Self: ...
    ...
    def pivot(self, values: Sequence[str] | str, index: Sequence[str] | str, columns: Sequence[str] | str, aggregate_function: PivotAgg | pli.Expr = ..., maintain_order: bool = ..., sort_columns: bool = ..., separator: str = ...) -> Self: ...
    ...
    @overload
    def row(self, index: int | None = ..., *, by_predicate: pli.Expr | None = ..., named: Literal[False] = ...) -> tuple[Any, ...]: ...
    @overload
    def row(self, index: int | None = ..., *, by_predicate: pli.Expr | None = ..., named: Literal[True]) -> dict[str, Any]: ...
    @overload
