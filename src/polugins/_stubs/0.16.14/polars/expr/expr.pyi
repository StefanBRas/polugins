...
from polars.datatypes import Struct as Struct, UInt32 as UInt32, is_polars_dtype as is_polars_dtype, py_type_to_dtype as py_type_to_dtype
...
class Expr:
    ...
    def top_k(self, k: int = ..., descending: bool = ...) -> Self: ...
    ...
    def abs(self) -> Self: ...
    def argsort(self, descending: bool = ..., nulls_last: bool = ...) -> Self: ...
