...
from typing import Any, BinaryIO, Callable, Collection, Concatenate, Iterable, Iterator, Literal, Mapping, NoReturn, Sequence, TypeAlias, TypeVar, overload
...
class DataFrame:
    ...
    def transpose(self, *, include_header: bool = ..., header_name: str = ..., column_names: Iterable[str] | None = ...) -> Self: ...
    ...
    def top_k(self, k: int, *, by: IntoExpr | Iterable[IntoExpr], descending: bool | Sequence[bool] = ..., nulls_last: bool = ...) -> DataFrame: ...
    def bottom_k(self, k: int, *, by: IntoExpr | Iterable[IntoExpr], descending: bool | Sequence[bool] = ..., nulls_last: bool = ...) -> DataFrame: ...
    ...
    def join_asof(self, other: DataFrame, *, left_on: str | None | Expr = ..., right_on: str | None | Expr = ..., on: str | None | Expr = ..., by_left: str | Sequence[str] | None = ..., by_right: str | Sequence[str] | None = ..., by: str | Sequence[str] | None = ..., strategy: AsofJoinStrategy = ..., suffix: str = ..., tolerance: str | int | float | None = ..., allow_parallel: bool = ..., force_parallel: bool = ...) -> DataFrame: ...
    def join(self, other: DataFrame, on: str | Expr | Sequence[str | Expr] | None = ..., how: JoinStrategy = ..., *, left_on: str | Expr | Sequence[str | Expr] | None = ..., right_on: str | Expr | Sequence[str | Expr] | None = ..., suffix: str = ...) -> DataFrame: ...
    ...
    def shift_and_fill(self, fill_value: int | str | float, *, periods: int = ...) -> DataFrame: ...
    ...
    def unique(self, subset: str | Sequence[str] | None = ..., *, keep: UniqueKeepStrategy = ..., maintain_order: bool = ...) -> DataFrame: ...
