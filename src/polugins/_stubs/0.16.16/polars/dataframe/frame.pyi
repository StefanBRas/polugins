...
class DataFrame:
    ...
    def join(self, other: DataFrame, left_on: str | Expr | Sequence[str | Expr] | None = ..., right_on: str | Expr | Sequence[str | Expr] | None = ..., on: str | Expr | Sequence[str | Expr] | None = ..., how: JoinStrategy = ..., suffix: str = ...) -> Self: ...
    ...
    def pivot(self, values: Sequence[str] | str, index: Sequence[str] | str, columns: Sequence[str] | str, aggregate_function: PivotAgg | Expr = ..., maintain_order: bool = ..., sort_columns: bool = ..., separator: str = ...) -> Self: ...
